...
use MembreBundle\Form\MembreType;
...
class MembreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $membres = $em->getRepository('MembreBundle:Membre')->findAll();
    ...
    {
        $membre = new Membre();
        $form = $this->createForm('MembreBundle\Form\MembreType', $membre);
    ...
    {
        $deleteForm = $this->createDeleteForm($membre);
        $editForm = $this->createForm('MembreBundle\Form\MembreType', $membre);
