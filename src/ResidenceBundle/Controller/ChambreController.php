...
use ResidenceBundle\Entity\Chambre;
use ResidenceBundle\Form\ChambreType;
...
class ChambreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $chambres = $em->getRepository('ResidenceBundle:Chambre')->findAll();
    ...
    {
        $chambre = new Chambre();
        $form = $this->createForm('ResidenceBundle\Form\ChambreType', $chambre);
    ...
    {
        $deleteForm = $this->createDeleteForm($chambre);
        $editForm = $this->createForm('ResidenceBundle\Form\ChambreType', $chambre);
